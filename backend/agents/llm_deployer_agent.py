...
llm_deployer_agent_options = ClaudeAgentOptions(
    system_prompt=(
        ...
        "- If RunPod deployment fails (e.g. due to insufficient credits or balance), DO NOT attempt other methods like deploy-hub-repo. Immediately stop and report the failure.\n\n"
        "TOOLS:\n"
